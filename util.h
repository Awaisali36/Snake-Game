...
// In other words you can use colorname as an index in color array (see belo
//void initialisinggrid(int ,int );
//void drawinggrid();
...
//void DrawString(int x, int y, const string& str, const string& a_score, float * color = NULL);
